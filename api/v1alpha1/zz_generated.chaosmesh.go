...
// GetRemoteCluster returns the remoteCluster
func (in *HelloWorldChaos) GetRemoteCluster() string {
	return in.Spec.RemoteCluster
}
...
func (in *HelloWorldChaos) ValidateCreate() (admission.Warnings, error) {
	HelloWorldChaosWebhookLog.Info("validate create", "name", in.Name)
	return in.Validate()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (in *HelloWorldChaos) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (in *HelloWorldChaos) ValidateDelete() (admission.Warnings, error) {
...
func (in *HelloWorldChaos) Validate() ([]string, error) {
	errs := gw.Validate(in)
	return nil, gw.Aggregate(errs)
}
